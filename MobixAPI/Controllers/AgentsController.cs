...
public class AgentsController : ControllerBase
{
    ...
    public async Task<IActionResult> Chat([FromBody] AgentChatRequest req)
    {
        ...
        var systemPrompt = """
            ...
            6. searchAlias: მომხმარებლები ქართულად ეძებენ — ჩაწერე ქართული სიტყვები მძიმით გამოყოფილი.
               მაგ. iPhone 16 Pro-სთვის: "აიფონი, აიფონი 16, აიფონი 16 პრო, ეფლი, სმარტფონი, ახალი აიფონი"
               Samsung-სთვის: "სამსუნგი, გალაქსი, სამსუნგი S25, ანდროიდი"
               Xiaomi-სთვის: "შიაომი, რედმი, მი ფონი"
               ყოველთვის ქართული ტრანსლიტერაცია + ზოგადი სიტყვები (სმარტფონი, ტელეფონი, მობილური)
